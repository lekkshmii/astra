...
class FixedFractionalSizer(BasePositionSizer):
    ...
    def __init__(self, fraction_per_position: float = 0.20):
...
class PositionSizer:
    ...
    def __init__(self, default_method: str = "VolatilityTarget"):
    ...
    def size_positions(self,
        ...
        if method_name not in self.methods:
            raise ValueError(f"Unknown position sizing method: {method_name}")
