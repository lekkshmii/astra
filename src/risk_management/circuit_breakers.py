...
class CircuitBreakerManager:
    ...
    def register_breaker(self, breaker: BaseCircuitBreaker):
    ...
    def get_trading_status(self) -> Dict[str, Any]:
        ...
        """
        emergency_halts = [name for name in self.active_halts]
